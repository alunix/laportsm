...
<div class="row page-titles">
        ...
        <div class="col-md-6 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Buat Tag</h3>
        </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-block">
                <form class="form-horizontal form-material" action="{{ route('tag.store') }}" method="post" role="form">
                        {{ csrf_field('') }}

                    <div class="form-group">
                        <label class="col-md-12" for="judul"><h3 class="text-themecolor m-b-0 m-t-0">Nama</h3></label>
                        <div class="col-md-12">
                            <input type="text" placeholder="Nama Tag" class="form-control form-control-line" name="nama">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Deskripsi Tag" class="form-control form-control-line" name="deskripsi">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <input type="Slug" placeholder="Slug Tag" class="form-control form-control-line" name="slug">
                        </div>
                    </div>
